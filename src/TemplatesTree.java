...
public class TemplatesTree extends JPanel implements TreeSelectionListener {
	...
	//System.out.println("Imposition: " + PrepsTemplate.getColumnsCount(sign) + "x" + PrepsTemplate.getRowsCount(sign));
	...
	staticPane.getPrepLayoutPanel().makeImpositionGrid(rows, cols, width, height, numbers, rotations);
    }
